...
describe('bufferToInt', function () {
  it('should convert a int to hex', function () {
    ...
    assert.equal(wshUtils.bufferToInt(new Buffer([])), 0)
  })
...
describe('isValidPrivate', function () {
  ...
  it('should fail on short input', function () {
    var tmp = '0011223344'
    assert.equal(wshUtils.isValidPrivate(new Buffer(tmp, 'hex')), false)
  })
  ...
  it('should work otherwise (< N)', function () {
    ...
    assert.equal(wshUtils.isValidPrivate(new Buffer(tmp, 'hex')), true)
  })
})
...
describe('toBuffer', function () {
  it('should work', function () {
    // Buffer
    assert.deepEqual(wshUtils.toBuffer(new Buffer([])), new Buffer([]))
    // Array
    assert.deepEqual(wshUtils.toBuffer([]), new Buffer([]))
    // String
    assert.deepEqual(wshUtils.toBuffer('11'), new Buffer([49, 49]))
    assert.deepEqual(wshUtils.toBuffer('0x11'), new Buffer([17]))
    assert.deepEqual(wshUtils.toBuffer('1234').toString('hex'), '31323334')
    assert.deepEqual(wshUtils.toBuffer('0x1234').toString('hex'), '1234')
    // Number
    assert.deepEqual(wshUtils.toBuffer(1), new Buffer([1]))
    // null
    assert.deepEqual(wshUtils.toBuffer(null), new Buffer([]))
    // undefined
    assert.deepEqual(wshUtils.toBuffer(), new Buffer([]))
    // 'toArray'
    assert.deepEqual(wshUtils.toBuffer(new BN(1)), new Buffer([1]))
  })
...
describe('baToJSON', function () {
  ...
  it('should turn a buffers into string', function () {
    assert.deepEqual(wshUtils.baToJSON(new Buffer([0])), '0x00')
  })
})
